  ...
  return (
    <div className="shadow-md w-full sticky top-0 left-0">
      ...
      text-gray-800"
        ...
        <ul className={`h-[10.5rem] md:h-auto md:flex md:items-center md:pb-0 bg-slate-100 rounded-b-[.8rem] md:rounded-b-[0rem] md:bg-white absolute md:static bg-white md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${
