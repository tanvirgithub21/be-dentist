      ...
      <div className="containerBox mx-3 md:w-[70%] md:mx-auto h-full  items-center flex">
        ...
        <div className="homeWrap flex md:h-[300px]">
          ...
          <div className="homeText text-gray-black flex flex-col justify-center ">
            <h2 className="homeTitle ml-16 md:ml-0 text-[1.3rem] md:text-4xl font-semibold mb-6 min-w-[175px] md:min-w-[300px] text-[#00b8d2] fontCss leading-[1.5] tracking-[.3rem] ">Every Smile <br /> has a Story </h2>
